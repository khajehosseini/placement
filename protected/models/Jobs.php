...
class Jobs extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'tblExperts' => array(self::MANY_MANY, 'Expert', '{{job_expert_assign}}(job_code, expert_code)'),
			'tblSkills' => array(self::MANY_MANY, 'Skill', '{{job_skill_assign}}(job_code, skill_code)'),
		);
	}
